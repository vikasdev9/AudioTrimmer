...
@Composable
fun RecordAudioErrorScreen(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Something went wrong while recording audio. Please make sure microphone permission is granted and try again.",
                    fontSize = 16.sp,
